...
# Feature: Playlist Range Selection
...
input_ui = widgets.VBox([
    widgets.HTML("<h3>🚀 Ultimate Downloader v4.22 (Gemini Version)</h3>"),
...
def process_youtube_link(url, mode="video"):
    ...
    ydl_opts = {
        ...
        # 'playliststart': playlist_start.value (Replaced by items below)
    }
    
    # Feature: Custom Playlist Range
    ...
    try:
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            for i, entry in enumerate(entries, 1):
                ...
                # Dynamic extension check (mkv vs srt)
...
def handle_file_processing(file_path, source="generic"):
    ...
    for f_path in archive_files:
        ...
        # Security: Restore unsafe path warning
        ...
        if os.path.exists(extracted_full) and not os.path.isdir(extracted_full):
            ...
            # Post-extract Duplicate Check: Restore Warning
...
def execute_batch(mode):
    ...
    try:
        ...
        # Fix: Restored full site support list
