...
input_ui = widgets.VBox([
    widgets.HTML("<h3>🚀 Ultimate Downloader v4.16 (Playlist Start)</h3>"),
...
def setup_environment(needs_mega, needs_ytdlp, needs_aria):
    ...
    if needs_ytdlp and not shutil.which('ffmpeg'): apt_packages.append("ffmpeg")
...
def process_youtube_link(url, mode="video"):
    ...
    ydl_opts = {
        ...
        'playliststart': playlist_start.value  # <--- DYNAMIC START INDEX
    }
